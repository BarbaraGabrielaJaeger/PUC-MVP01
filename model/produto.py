teste# BARBARA GABRIELA JAEGER
# Sprint: Desenvolvimento Full Stack Básico (40530010058_20240_04)
# modelo classe produto que chama a tabela
...
class Produto(Base):
    ...
    def __init__(self, nome:str, quantidade:int, valor:float,
        ...
        self.valor = valor
        # poderia ser criado um campo codigo de barras 
        # recebendo um valor autoincremental com o id do produto
